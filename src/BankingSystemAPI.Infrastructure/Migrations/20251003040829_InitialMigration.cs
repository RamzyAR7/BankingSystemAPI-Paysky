    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false, defaultValueSql: "NEXT VALUE FOR [AccountIdSequence]"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CheckingAccounts_Currencies_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AbsoluteExpiresOn = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterestType = table.Column<int>(type: "int", nullable: false, comment: "1=Monthly, 2=Quarterly, 3=Annually, 4=Every5Minutes(Testing)")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavingsAccounts_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterestLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InterestLogs_SavingsAccounts_SavingsAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterestLogs_SavingsAccountId",
                table: "InterestLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavingsAccount_InterestType",
                table: "SavingsAccounts",
                column: "InterestType");

            migrationBuilder.CreateIndex(
                name: "IX_SavingsAccounts_CurrencyId",
                table: "SavingsAccounts",
                column: "CurrencyId");
