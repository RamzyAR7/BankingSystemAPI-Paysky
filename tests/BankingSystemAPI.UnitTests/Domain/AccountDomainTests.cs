...
/// <summary>
/// Tests for domain entity behavior and business rules.
...
public class AccountDomainTests
{
    ...
    public void CheckingAccount_BalanceVsOverdraftCredit_ConceptualSeparation()
    {
        ...
        Assert.Equal(100m, account.GetOverdraftUsed()); // Amount borrowed from bank ??
        Assert.Equal(200m, account.GetAvailableOverdraftCredit()); // Bank can still lend 200 more ??
        Assert.Equal(200m, account.GetMaxWithdrawalAmount()); // Can still withdraw 200 more ?
