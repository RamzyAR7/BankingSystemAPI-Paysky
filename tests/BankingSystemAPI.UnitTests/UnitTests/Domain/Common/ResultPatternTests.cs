...
namespace BankingSystemAPI.UnitTests.UnitTests.Domain.Common;

/// <summary>
/// Tests for the Result pattern implementation in the domain layer.
/// </summary>
public class ResultPatternTests
{
    ...
    [Fact]
    public void SuccessResult_HasNoErrors()
    {
        // Act
        var result = Result.Success();
    ...
    [Fact]
    public void FailureResult_HasErrors()
    {
        // Arrange
        var error = "Test error";
    ...
    [Fact]
    public void ErrorMessage_IsSetCorrectly()
    {
        // Arrange
